...
import { WidgetChartsProps } from '@/features/dashboard/types.presentation';
    ...
    return (
        ...
        >
            {pieData?.length > 0 && (
                ...
                >
                    <p className="text-center text-xs font-semibold text-ink-muted">{pie?.title ?? 'Distribution'}</p>
            ...
            {radarData?.length > 0 && (
                ...
                >
                    <p className="text-center text-xs font-semibold text-ink-muted">{radar?.title ?? 'Distribution'}</p>
            ...
            {barData?.length > 0 && (
                ...
                >
                    <p className="text-center text-xs font-semibold text-ink-muted">{bar?.title ?? 'Duration (in months)'}</p>
