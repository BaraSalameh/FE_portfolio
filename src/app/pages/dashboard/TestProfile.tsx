...
import { Button, CUDModal, Paragraph, ResponsiveIcon } from '@/components';
...
export const TestProfile = ({ 
  ...
  return (
    <div className='sm:flex'>
        <Header paddingY='xs' itemsX='center' className={`${className}`}>
            <div className="w-full h-65 sm:h-100 gap-5 bg-light-component dark:bg-dark-component rounded-2xl">
        ...
        <Header paddingY='xs' itemsX='center'>
            <div className='flex-col space-y-5 w-full h-65 sm:h-110 py-5'>
                <div className='flex h-20 gap-5'>
                    <div className='w-full bg-light-component dark:bg-dark-component rounded-2xl space-y-3 p-3'>
                        <Paragraph size="lg" space="xs">
                            <ResponsiveIcon icon={GraduationCap} />
                            Education
                        </Paragraph>
                        <Paragraph>
                            {`Total education count:  ${lstEducations.length}`}
                        </Paragraph>
                    </div>
                    <div className='w-full bg-light-component dark:bg-dark-component rounded-2xl space-y-3 p-3'>
                        <Paragraph size="lg" space="xs">
                        ...
                        <Paragraph>
                            {`Total experience count:  ${lstExperiences.length}`}
                        </Paragraph>
                    </div>
                </div>
                <div className='flex h-20 gap-5'>
                    <div className='w-full bg-light-component dark:bg-dark-component rounded-2xl space-y-3 p-3'>
                        ...
                        <Paragraph>
                            {`Total language count: ${lstUserLanguages.length}`}
                        </Paragraph>
                    </div>
                    <div className='w-full bg-light-component dark:bg-dark-component rounded-2xl space-y-3 p-3'>
                       <Paragraph size="lg" space="xs">
                        ...
                        <Paragraph>
                            {`Total project count:  ${lstProjectTechnologies.length}`}
                        </Paragraph>
                    </div>
                </div>
                <div className="bg-light-component dark:bg-dark-component rounded- space-y-3 p-3">
                    <Paragraph size="lg">
                        Bio
                    </Paragraph>
