...
import { userChartPreferenceSchema, UserChartPreferenceFormData } from "@/lib/schemas";
...
import { chartTypeListQuery, editUserChartPreference, userChartPreferenceListQuery, widgetListQuery } from "@/lib/apis";

const UserChartPreferenceForm = ({id, onClose, preferenceKeys, preferenceValues} : UserChartPreferenceProps) => {
...
export default UserChartPreferenceForm;